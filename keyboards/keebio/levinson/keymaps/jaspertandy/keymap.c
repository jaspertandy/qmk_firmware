...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  BL_STEP, KC_F7,       KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS),_______, _______, VIMUX_PROMPT, \
  TMUX_PANE_P, TMUX_PANE_N, TMUX_WIN_P, TMUX_WIN_N, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
