...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, TMUX_P0, TMUX_P1, TMUX_P2, TMUX_P3, TMUX_P4, TMUX_P5, S(KC_NUHS),S(KC_NUBS),_______, LALT(KC_3), SCREENSHOT_COPY, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  VIMUX_PROMPT, VIM_NOHLSEARCH, _______, VIMUX_REPEAT, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  RESET, _______, _______, _______, _______, _______, TMUX_D, _______, _______, _______, _______, _______, \
