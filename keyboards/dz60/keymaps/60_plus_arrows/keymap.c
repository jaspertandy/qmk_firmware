 ...
 * |-----------------------------------------------------------------------------------------+
 * | Sft | Sft |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  | RSh |  U  | FN  |
 * |-----------------------------------------------------------------------------------------+
 * | Ctrl |  Alt  |  Cmd  |              Space                | Cmd |  `  |  L  |  D  |  R  |
 * `-----------------------------------------------------------------------------------------'
 */
  ...
  LAYOUT_directional(
      ...
      KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_RGUI, KC_GRV, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
 ...
 */
  ...
  LAYOUT_directional(
      ______, BL_TOGG, BL_STEP, BL_DEC, BL_INC, ______, ______, RESET, ______, ______, ______, ______, ______, ______, ______,
      ...
      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_RCTL, ______,
