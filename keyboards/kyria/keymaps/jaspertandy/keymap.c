...
/*
 * Lower Layer: Symbols right hand
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |        |      | :Ack | \vp  |      |      |                              |   !   |  @   |  ?   |  $   |     |   ~    |
 * ,-------------------------------------------.                              ,-------------------------------------------.
 ...
 */
    [_LOWER] = LAYOUT(
      _______, KC_EXCLAIM, KC_AT,   KC_HASH,    KC_DOLLAR,    KC_PERCENT,                                         KC_CIRCUMFLEX, KC_AMPERSAND, KC_ASTERISK, KC_MINS,  KC_UNDERSCORE, KC_EQL,
      _______, _______,    _______, FORCE_HASH, _______,      _______,                                            KC_LEFT,       KC_DOWN,      KC_UP,       KC_RIGHT, _______,       KC_TILDE,
      _______, _______,    _______, _______,    VIMUX_PROMPT, VIMUX_REPEAT, _______, _______,   _______, _______, _______,       _______,      KC_LT,       KC_GT,    _______,       KC_GRV,
