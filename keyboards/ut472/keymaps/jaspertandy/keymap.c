...
LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, KC_APP,  MO(1),      KC_SPC,        MO(2),  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
LAYOUT( /* RIGHT */
  ...
  _______, _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_LT,   KC_GT,   _______,  KC_BSLS,
  _______, _______, _______, KC_CAPS, _______,     _______,      _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
